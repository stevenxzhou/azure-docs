...
**2.1.5**
- Fixing iOS cursor jumps issue when editing in the middle of the text.
...
**2.1.5**
- Adding default flavor for idpselector template on sign in page.
- Fixing a encoding issue with sign-in link text.
